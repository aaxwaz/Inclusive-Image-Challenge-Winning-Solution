...
if __name__ == '__main__':
    ...
    CACHE_PATH_TEST = OUTPUT_PATH + 'cache_inception_resnet_weimin_4/'
...
if __name__ == '__main__':
    ...
    model_saved_path = ROOT_PATH + 'model_4/new_xception_latest.h5'

    create_submission(model_saved_path, is_weights=True)

    matrix_pred, matrix_real = get_tuning_matrix_from_cache_tst(CACHE_PATH_TEST, OUTPUT_PATH + 'cache_xception_new_weimin.pklz')
    ...
    save_in_file(thr_arr, OUTPUT_PATH + 'thr_arr_xception_sp_{}_ep_{}_min_{}_def_{}.pklz'.format(sp, ep, minThr, default))
