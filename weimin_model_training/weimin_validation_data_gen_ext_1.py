...
if __name__ == '__main__':
    ...
    CACHE_PATH_TEST = OUTPUT_PATH + 'cache_inception_resnet_weimin_1/'
...
if __name__ == '__main__':
    ...
    model_saved_path = ROOT_PATH + 'model_1/inception_resnet_v2_latest.h5'

    create_submission(model_saved_path, is_weights=True)

    matrix_pred, matrix_real = get_tuning_matrix_from_cache_tst(CACHE_PATH_TEST, OUTPUT_PATH + 'cache_inception_resnet_weimin_v2.pklz')
    ...
    save_in_file(thr_arr, OUTPUT_PATH + 'thr_arr_inception_resnet_version_2_sp_{}_ep_{}_min_{}_def_{}.pklz'.format(sp, ep, minThr, default))
